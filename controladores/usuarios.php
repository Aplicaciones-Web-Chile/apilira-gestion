...
class usuarios
{
    ...
    /**
     * Crea un nuevo usuario de API en la base de datos
     */
    ...
    /**
     * Crea un nuevo usuario en la tabla "usuarios de API"
    ...
    private function crear($datosUsuario)
    {
        ...
        try {
            ...
            //throw new ExcepcionApi(self::ESTADO_ERROR_BD, $comando);
    ...
    private function loguear()
    {
        ...
        //throw new ExcepcionApi(self::ESTADO_FALLA_DESCONOCIDA, $id_usuario);
